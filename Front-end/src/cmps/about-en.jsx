        ...
        <section className="screen-continer ">
            ...
            <div className="text-continer">
                ...
                <div className="txt">The system is provided with three user groups:
                    ...
                    In the system, the list of users includes three fixed users who cannot be
                ...
                <p className="txt">
                    ...
                    <br />
                    <br />
                    Important: The three default users cannot be modified or removed.
                    <br />
                    <br />
                    ...
                    <p className="txt">
                        ...
                        an alarm will be triggered and added to the log with a timestamp indicating the start
                        of the alarm.
                        <br />
                        <br />
                        ...
                        <br />
                        Closed Alarm with Acknowledgement - Permanently removed from the log.                    <br />
                        <br />
                        <br />
